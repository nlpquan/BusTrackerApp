    ...
    public partial class AddedRolesToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBooking", x => x.CustomerBookingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DriverTicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdminId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DriverId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BusRoute = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverTicket", x => x.DriverTicketId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b8c8a678-e44f-42f2-bfbf-5fa9e6745b26"), null, "Driver", "DRIVER" },
                    { new Guid("d8c7b6a5-9e8d-1234-5678-90abcdef1234"), null, "Customer", "CUSTOMER" },
                    { new Guid("f5b28ab8-3031-4d80-9b87-7e4cf91e6d30"), null, "Administrator", "ADMINISTRATOR" }
                });
